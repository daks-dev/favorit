...
until [ $ac = "-" ]; do
    ...
    case $ac in
        ...
        "s")
            ...
            until [[ $acc == "-" ]]; do
                echo -e "";
                echo -e "    1 : restart vps.favorit";
                echo -e "    2 : restart dev.favorit";
                ...
                case $acc in
                    "1")
                        echo -e "> supervisor:restart vps.favorit";
                        sudo supervisorctl reread;
                        sudo supervisorctl restart vps.favorit;;
                    "2")
                        echo -e "> supervisor:restart dev.favorit";
                        sudo supervisorctl reread;
                        sudo supervisorctl restart dev.favorit;;
                    "3")
